...
export function Sidebar({ onDisconnect }: Props) {
  ...
  return (
    <div
      className="w-[260px] bg-zinc-950 border-r border-zinc-800/60 flex flex-col select-none shrink-0"
      data-tauri-drag-region
    >
      {/* Header — macOS traffic light padding */}
      <div className="flex items-center gap-2 px-4 pt-10 pb-3" data-tauri-drag-region>
      ...
      <div className="px-3 mb-2">
        <button
          ...
          className="flex items-center gap-2 w-full px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-800 text-xs font-medium text-zinc-300 hover:bg-zinc-800 hover:border-zinc-700 transition-colors"
        >
      ...
      {/* Tab switcher */}
      <div className="flex mx-3 mb-2 bg-zinc-900 rounded-lg p-0.5">
        <TabButton
                ...
                {filteredConversations.map((conv) => (
                  ...
                  >
                    <button
                      ...
                      className={`flex items-center w-full px-2.5 py-2 rounded-lg text-left text-xs transition-colors ${
                        conv.id === activeId
      ...
      <div className="px-3 py-3 border-t border-zinc-800/60 space-y-2">
        ...
        <button
          ...
          className="flex items-center gap-2 w-full px-2.5 py-1.5 rounded-lg text-xs text-zinc-500 hover:text-zinc-300 hover:bg-zinc-900 transition-colors"
        >
...
function TabButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex items-center justify-center gap-1.5 flex-1 py-1.5 rounded-md text-[11px] font-medium transition-colors ${
        active
